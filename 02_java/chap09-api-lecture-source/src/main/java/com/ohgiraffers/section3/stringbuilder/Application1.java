package com.ohgiraffers.section3.stringbuilder;

public class Application1 {
    public static void main(String[] args) {

        /* 수업목표. String과 StringBuilder(또는 StringBuffer)와의 차이점에 대해 이해하고 사욯할 수 있다. */
        /* 설명.
         *  String은 불변객체(immutable object), StringBuilder(또는 StringBuffer)는 가변객체(mutable object)l
        * */
        String testStr = "java";
