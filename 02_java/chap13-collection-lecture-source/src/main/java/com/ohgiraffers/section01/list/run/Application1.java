...
public class Application1 {
    public static void main(String[] args) {
         ...
         *  3. 경우에 따라(제네릭 타입을 생략하면) 다양한 값을 한 번에 저장할 수 있다. (Object[]과는 별로 큰 차이 X)
         *  4. 중간에 값을 추가 및 삭제가 편리하다 (feat. 속도는 다소 느릴 수 있음)
         * */
...
//        List<String> stringList = new ArrayList<>();     // 필수는 아니지만 관례상 컬렉션은 다형성을 주로 적용한다.
        ...
        /* 설명. 내림차순 하는 방법 */
        /* 설명. 다루는 Iterator와 해당 컬렉션의 제네릭 타입은 왠만하면 꼭 명시하자(Iterator<String>) */
