...
public class Application {
    public static void main(String[] args) {
        ...
        /* 설명. 1. enum 타입은 최소 사용 시 singleton 객체가 주입되며 같은 값에 대해선 동일비교가 가능
         * 설명.
         *   열거 타입으로 선언된 인스턴스는 싱글톤으로 관리되며 인스턴스가 각각 한 게임을 보장한다.
         *   작성한 수선에 따라 각각 다른 인스턴스가 생성되어 활당되며 최초 호출 시에 enum의 생성자들
