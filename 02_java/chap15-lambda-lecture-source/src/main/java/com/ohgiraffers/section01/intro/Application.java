...
public class Application {
    public static void main(String[] args) {
        ...
        Calculator cal = new CalculatorTmpl();
        System.out.println("10과 20의 합은? " + cal.sumToNumbers(10, 20));   // 동적 바인딩 발생

        /* 설명. 2. 익명 클래스(Anoymous Class)를 활용한 방식 */
        // 현재에는 잘 쓰지 않는 방식이다.
        ...
        /* 설명. 3. 람다식을 활용한 방식 */
        /* 설명.
         *  람다식은 익명함수로 함수형 인터페이스를 활용해 하위 구현체의 메소드를 오버라이딩 하느 느낌으로
         *  작성하게 된다. 이때 반드시 함수형 인터페이스여야 추상메소드가 하나만 존재하므로 익명 함수가 성립된다.
         *
         *  설명.
         *   기본 규칙
         *    1. 구현하는 메소드의 body부분에서 실행 구문이 하나일 경우 중괄호 {}를 생략 가능하다.
         *    2. 실행 될 구문이 표현식일 경우(또한 return을 유추할 수 있는 경우)에는 return이 생략 가능하다.
         *    3. 매겨변수의 소괄호는 기본적으로는 생략할 수 없지만, 매개변수가 하나일 경우에는 소괄호도 생략 가능하다.
        * */
