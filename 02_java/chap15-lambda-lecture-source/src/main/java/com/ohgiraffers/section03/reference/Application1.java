...
public class Application1 {
    public static void main(String[] args) {
        ...
        /* 수업목표. 기존에 존재하는 메소드를 참조해 람다식을 적용할 수 있다.(feat.람다식으로 또 굳이 작성할 필요 X) */
...
//        biFunction = (x,y) -> x.equals(y);
        ...
        /* 설명. non-static 메소드를 참조하는 경우 클래스명이 아닌 참조변수명을 활용할 수 있다. */
        // String으로 선언된 값을 리스트에 있는 요소에 동일하게 적용시키고 싶을 때 사용
        String prefix = "Hello ";
...
//                .forEach(String name -> System.out.println(name));
        ...
        /* 설명. 메소드 참조 시에는 참조한 메서드를 호출하는 객체가 정해진 경우(참조변수)와
