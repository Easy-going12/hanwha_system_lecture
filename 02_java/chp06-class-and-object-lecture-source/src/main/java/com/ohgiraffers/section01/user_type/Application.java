...
public class Application {
     ...
     *   : 추상화, 캡슗화, 상속, 다형성을 적용하여  유지보수성을 고려한 응집력 높고 결합도 낮은
     *     객체 위주의 개발방시기을 추구하는 프래그래밍을 말한다
     *
     * 설명.
     *   객체지향의 특징(4대 특징)
    ...
    * */
    ...
    public static void main(String[] args) {
        ...
        * */
        ...
        System.out.println("메소드를 호출할 때 넘겨준 null의 값: " + num);

        /* 설명.
         * 기본 자료형의 값을 넘길 때 vs 참조자료형의 값을 넘길 때
         * 1. 기본자료형은 메소드를 호출한 곳이 영향을 받지 X
         * 2. 참조자료형은 메소드를 호출한 곳이 영향을 받을 수 0(feat. 반환 할 필요 X)
        * */
    }
