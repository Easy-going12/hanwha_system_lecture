...
public class Application {
    public static void main(String... args) {
        ...
        /* 설명. 실행 시 넘겨준 arguments 확인해 보자 */
        System.out.println(Arrays.toString(args));

        /* 수업목표. 메소드의 파라미터(매개변수)에 대해 이해하고 사용할 수 있다. */
        ParameterTest pt = new ParameterTest();

        /* 목차. 1. 기본자료형을 매개변수로 전달 받는 메솓드 호출 */
        int num = 20;
...
//        rect.calRound();
        ...
        pt.testVariabeLengthArrayParmeter();
        pt.testVariabeLengthArrayParmeter("홍길동");
        pt.testVariabeLengthArrayParmeter("유관순", "볼링");
        pt.testVariabeLengthArrayParmeter("강감찬", "낚시", "독서");
        pt.testVariabeLengthArrayParmeter(new String[]{"강감찬", "낚시", "독서"});
