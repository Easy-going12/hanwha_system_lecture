...
public class MenuService {
    ...
    public List<com.ohgiraffers.section02.javaconfig.MenuDTO> findAllMenus() {


        SqlSession sqlSession = getSqlSession();
        /* 설명
         *  SqlSession을 활용해서 인터페이스의 하위 구현체들 DAO에 해당하는 객체로 만들어 쿼리 실행
         * */
    ...
    public boolean registMenu(com.ohgiraffers.section02.javaconfig.MenuDTO menu) {
        SqlSession sqlSession = getSqlSession();
        menuMapper = sqlSession.getMapper(MenuMapper.class);
