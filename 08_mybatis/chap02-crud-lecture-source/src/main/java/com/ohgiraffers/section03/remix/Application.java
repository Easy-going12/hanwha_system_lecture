...
public class Application {
    public static void main(String[] args) {
        ...
        do{
            ...
            System.out.println("2. 메뉴 코드도 메뉴 조회");
    ...
    /* 설명. Map<String, String> 형태로 web에서처럼(request의 parameter 개념으로) Key, Value 형태로 넘길 예정 */
    ...
    private static Map<String,String> inputModifyMenu() {
        ...
        System.out.print("변경할 메뉴의 번호을 입력해 주세요: ");
        String menuCode = sc.nextLine();
        System.out.print("변경할 메뉴의 이름을 입력해 주세요: ");
        String menuName = sc.nextLine();
        System.out.print("변경할 메뉴의 가격를 입력해 주세요: ");
        String menuPrice = sc.nextLine();
