...
public class ProblemsOfUsingDirectSqlTest {
    ...
    * */
    ...
    @DisplayName(("직접 SQL을 작성하며 메뉴를 조회할 때 발생하는 문제 확인"))
    @Test
    ...
    * */
     ...
     *      private String menuName;
     *      private int menuPrice;
     *      private Category category;  // join 할때 category 안의 속성을 볼 수가 없다.
     *      private String orderableStatus;
     *  }
    * */

    // CQRS는 JPA는 데이터 수정에 용이하고 Mybatis는 join, 조회에 용이하다.

    /* 설명. 4. 동일성 보장 문제 */
    @DisplayName("조회한 두 개의 램을 담은 객체의 동일성 비교 테스트")
    @Test
    void testEquals() throws SQLException {
        ...
        // java에서는 query로 인해 new로 두 개의 생성자를 생성했기 때문에 서로 다르게 취급하지만 db에서도 같은 값으로 본다.
     ...
     *  System.out.println(menu1 == menu2); //True가 나옴 => 값이 다름
    * */
}
