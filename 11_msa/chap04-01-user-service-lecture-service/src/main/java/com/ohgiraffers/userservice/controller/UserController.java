...
import com.ohgiraffers.userservice.dto.RequestRegistUerDTO;
...
public class UserController {
    ...
    @PostMapping("/users")
    public ResponseEntity<ResponseRegistUserDTO> registUser(@RequestBody RequestRegistUerDTO newUser){
