/* 
  ...
  Node.js 환경에서는 global, 웹 브라우저 환경에서는 window가 이에 해당된다.
*/

console.log(globalThis);    // Node.js에서는 this 대신 globalthis를 해야 진짜 global 객체를 확인 가능
console.log(Object.getOwnPropertyDescriptor(globalThis));       // 좀 더 구체적으로 프로퍼티를 확인 가능
...
/* NaN */
console.log(globalThisThis.NaN);
