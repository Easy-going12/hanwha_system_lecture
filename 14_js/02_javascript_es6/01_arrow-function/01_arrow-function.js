...
/* 
   ...
   2. 화살표 함수 사용 시
      렉시컬 this(화살표 함수는 자신만의 this를 가지기 않음)
...
let theater = {
    store: '강남점',
    title: ['세계의 주인', '굿 보이', '부산 포니아', '디바 아누스','콘스탄틴'],
    showMovieList() {
        this.title.forEach(
...
const test = () => console.log(arguments);  // this와 마찬가지로 화살표 함수는 arguments가 아닌
                                            // 상위 개념(global 객체)의 arguments가 나옴

test(1,2,3,4,5);

const test2 = function(){
    console.log('normal function일 경우:', arguments);      // 넘어온 모든 인수를 유사배열로 가짐
}
