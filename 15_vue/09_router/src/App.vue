...
<!--
  RouterLink
  1. to 속성을 쓰면 url 주소를 바꿔준다. (클라이언트 라우팅, location.href 속성을 바꾸는 것과 같은 효과를 발생한다.)
  2. active-class를 쓰면 활성화된 버튼에 class 속성을 부여해서 css 적용
  3. replace를 쓰면 뒤로 가기를 맞는 효과를 낼 수 있다.
-->
<template>
  <header>
    <!-- <h2>basic router</h2>
